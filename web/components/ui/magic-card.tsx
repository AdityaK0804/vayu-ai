...
// Registry default is next-themes, which persists the theme to localStorage —
// forbidden by this build. Our theme lives in the in-memory Zustand store, so
// this shim keeps one source of truth and the component API unchanged.
import { useApp } from "@/lib/store"

function useTheme() {
  return { theme: useApp((s) => s.theme) }
}
