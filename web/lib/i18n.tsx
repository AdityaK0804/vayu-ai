...
const HI: Dict = {
  ...
  "Administrator sign-in": "प्रशासक साइन-इन",
  "Enforcement tools are restricted to authorised officials.":
    "प्रवर्तन उपकरण केवल अधिकृत अधिकारियों के लिए हैं।",
  "Admin ID": "प्रशासक आईडी",
  Password: "पासवर्ड",
  "Sign in": "साइन इन",
  "Sign out": "साइन आउट",
  ...
  "Not configured in the demo build": "डेमो बिल्ड में कॉन्फ़िगर नहीं है",
  "Demo credentials": "डेमो क्रेडेंशियल",
  "Unknown admin ID or password.": "अज्ञात प्रशासक आईडी या पासवर्ड।",
  "for enforcement tools": "प्रवर्तन उपकरणों के लिए",
  "Demo gate only — it hides UI, it does not secure data. Credentials ship in the client bundle.":
    "केवल डेमो गेट — यह UI छिपाता है, डेटा सुरक्षित नहीं करता। क्रेडेंशियल क्लाइंट बंडल में जाते हैं।",
  Explore: "अन्वेषण",
